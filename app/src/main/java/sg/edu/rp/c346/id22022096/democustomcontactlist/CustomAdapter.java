package sg.edu.rp.c346.id22022096.democustomcontactlist;
...
public class CustomAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        LayoutInflater inflater = (LayoutInflater) parent_context.getSystemService(parent_context.LAYOUT_INFLATER_SERVICE);
